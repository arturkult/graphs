...
static PyTypeObject SortedEdgesListTypeObj = {
	PyVarObject_HEAD_INIT(NULL, 0) "simple_graphs.SortedEdgesList",  /* tp_name */
...
PyMODINIT_FUNC PyInit_simple_graphs() {
	...
	NoVerticesError = PyErr_NewException("simple_graphs.SortedEdgeslist->NoVerticesError", NULL, NULL);
	PyDict_SetItemString(SortedEdgesListTypeObj.tp_dict, "NoVerticesError", NoVerticesError);

	TooManyVerticesError = PyErr_NewException("simple_graphs.SortedEdgeslist->TooManyVerticesError", NULL, NULL);
